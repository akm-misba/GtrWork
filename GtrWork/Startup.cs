...
using GtrWork.Common;
using GtrWork.Member;
using GtrWork.Member.Contexts;
using GtrWork.Member.Entities;
using GtrWork.Member.Services;
using GtrWork.Membership;
using GtrWork.Training;
...
namespace GtrWork
{
    public class Startup
    {
        ...
        public void ConfigureContainer(ContainerBuilder builder)
        {
            ...
            builder.RegisterModule(new MemberModule(connectionInfo.connectionString,
              connectionInfo.migrationAssemblyName));
