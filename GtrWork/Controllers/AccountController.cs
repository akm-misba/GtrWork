    ...
    public class AccountController : Controller
    {
       ...
       //private readonly RoleManager<Role> _roleManager;
        ...
        public async Task<IActionResult> Register(RegisterModel model)
        {
            ...
            {
                var user = new ApplicationUser { FullName=model.FullName,Number=model.Number,ImageUrl=model.ImageUrl,UserName = model.Email, Email = model.Email };
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        return RedirectToAction("RegisterConfirmation", "Account", new { email = model.Email, returnUrl = model.ReturnUrl ,imageUrl=model.ImageUrl});
                    }
                    else
                    {
